...
schedule_date = "11-13-2023"
output_path = directory_path + f"/GTFS Data/output_{schedule_date}.txt"
calendar_regex = re.compile(r'20231113,20240131|service_id', re.MULTILINE)
