"""grabs data from the api and sends it off to the isMetraokay twitter account"""
import os
...
# ENV Variables
twitter_api_key = os.getenv('IS_METRA_OKAY_API_KEY')
twitter_api_key_secret = os.getenv('IS_METRA_OKAY_API_KEY_SECRET')
twitter_access_token = os.getenv('IS_METRA_OKAY_ACCESS_TOKEN')
twitter_access_token_secret = os.getenv('IS_METRA_OKAY_ACCESS_TOKEN_SECRET')
twitter_bearer_key = os.getenv('IS_METRA_OKAY_BEARER_TOKEN')
